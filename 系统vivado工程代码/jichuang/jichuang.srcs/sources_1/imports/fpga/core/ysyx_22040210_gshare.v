...
always @(posedge clk ) begin
    ...
    end else if((!flush)&&(!stall )&& dec_dongtai == `ysyx_22040210_True)begin
        bhr <= {bhr[`ysyx_22040210_BHRLEN-2:0], (gshare_istaken1_o)||(dec_jalr | dec_jal)};
...
wire [`ysyx_22040210_BHR_BUS] phtbhr = gshare_prmiss_i ? {bpu_exfixbhr_i[`ysyx_22040210_BHRLEN-2:0],exisjump_i} : 
                                        ...
                                        {bhr[`ysyx_22040210_BHRLEN-2:0], (gshare_istaken1_o)||(dec_jalr | dec_jal)} :
                                        bhr;
